...
var _initNavToggles = require("./modules/nav-toggles/init-nav-toggles");
var _initVideo = require("./modules/hero/init-video");
var _initToursSlider = require("./modules/sliders/init-tours-slider.js");
var _initTrainingSlider = require("./modules/sliders/init-training-slider");
var _initReviewsSlider = require("./modules/sliders/init-reviews-slider");
var _initAdvantagesSlider = require("./modules/sliders/init-advantages-slider");
...
var _indent = require("./modules/hero/indent.js");
// ---------------------------------
...
},{"./modules/form-validate/form":3,"./modules/hero/indent.js":9,"./modules/hero/init-video":10,"./modules/leaflet/init-leaflet":11,"./modules/modals/init-modals":12,"./modules/nav-toggles/init-nav-toggles":14,"./modules/sliders/init-advantages-slider":15,"./modules/sliders/init-gallery-slider":16,"./modules/sliders/init-hero-slider":17,"./modules/sliders/init-reviews-slider":18,"./modules/sliders/init-tours-slider.js":19,"./modules/sliders/init-training-slider":20,"./utils/ios-vh-fix":23}],2:[function(require,module,exports){
"use strict";
...
var contentElement = heroElement.querySelector('.hero__content');
var getHeight = function getHeight() {
  if (headerElement) {
    var setHeight = function setHeight() {
      heroElement.style.marginTop = "-".concat(headerElement.offsetHeight, "px");
      contentElement.style.paddingTop = "".concat(headerElement.offsetHeight, "px");
    };
...
var videoLink = videoContainer.querySelector('.video__link');
var videoButton = videoContainer.querySelector('.video__button');
...
var initLeaflet = function initLeaflet() {
  if (myMap) {
    ...
    var tileLayer = (0, _leaflet.tileLayer)('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
    ...
    var marker = (0, _leaflet.marker)([55.816506445034176, 37.637011498705205], {
      icon: icon
    });
    marker.addTo(map);
  }
...
var createAdvantagessSlider = function createAdvantagessSlider() {
  if (advantagesSlider) {
...
exports.initGallerysSlider = void 0;
...
var initGallerysSlider = function initGallerysSlider() {
  if (gallerySlider) {
...
exports.initGallerysSlider = initGallerysSlider;
...
exports.initTrainigSlider = void 0;
var trainigSlider = document.querySelector('.training__slider');
var buttonPrev = document.querySelector('.training__button--prev');
var buttonNext = document.querySelector('.training__button--next');
var initTrainigSlider = function initTrainigSlider() {
  if (trainigSlider) {
...
exports.initTrainigSlider = initTrainigSlider;
